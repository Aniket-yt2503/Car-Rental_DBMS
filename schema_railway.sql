-- ============================================================
-- Car Rental Schema — Railway Compatible (no DROP/CREATE DB)
-- Paste this entire file into Railway's SQL Editor and run it
-- ============================================================
...
INSERT IGNORE INTO CarClass (class_name, price_per_day, price_per_week, price_per_2week, price_per_month) VALUES
...
INSERT IGNORE INTO DropOffCharge (class_name, from_location, to_location, charge) VALUES
...
INSERT IGNORE INTO Phone (person_id, phone_number) VALUES
(1, '555-0101'), (1, '555-0102'),
(2, '555-0201'), (9, '555-0901'),
(10, '555-1001'), (11, '555-1101'), (12, '555-1201');

INSERT IGNORE INTO Customer (person_id) VALUES (9), (10), (11), (12);

INSERT IGNORE INTO Employee (person_id, category, location_id) VALUES
(1, 'manager', 1),
(2, 'manager', 2),
(3, 'manager', 3),
(4, 'manager', 4),
...
INSERT IGNORE INTO Manager (person_id, title) VALUES
(1, 'president'),
(2, 'vp_operations'),
(3, 'vp_marketing'),
(4, 'manager'),
...
INSERT IGNORE INTO Promotion (class_name, week_start, discount_pct) VALUES
...
(10, 1, 1, 1, 'subcompact', '2023-04-01', '2023-04-02', 1000, 1100, 'full', 30.00, NULL),
(11, 2, 2, 2, 'subcompact', '2023-04-03', '2023-04-10', 5000, 5200, 'half', 180.00, NULL),
(12, 3, 3, 3, 'compact', '2023-05-01', '2023-05-15', 10000, 10500, 'empty', 420.00, NULL),
(10, 4, 4, 4, 'compact', '2023-06-01', '2023-07-01', 15000, 16000, 'full', 800.00, NULL),
(9, 5, 5, 5, 'sedan', '2023-07-01', '2023-07-03', 20000, 20100, 'full', 50.00, NULL),
(11, 6, 1, 2, 'sedan', '2023-08-01', '2023-08-02', 25000, 25200, 'full', 100.00, NULL),
(12, 7, 2, 2, 'luxury', '2023-09-01', '2023-09-02', 30000, 30100, 'full', 100.00, NULL),
(10, 8, 3, 3, 'luxury', '2023-10-01', '2023-10-06', 35000, 35500, 'full', 500.00, NULL),
...
CREATE OR REPLACE VIEW View_Q7 AS
SELECT
...
CREATE OR REPLACE VIEW View_Q8 AS
SELECT r.rental_id
FROM Rental r
...
CREATE OR REPLACE VIEW View_Q9 AS
SELECT MIN(rental_price) AS cheapest_price
FROM View_Q3;

CREATE OR REPLACE VIEW View_Q10 AS
SELECT c.make
FROM Car c
...
-- ========================
-- STORED PROCEDURE
-- (Run this separately in Railway if it causes an error here)
-- ========================

DROP PROCEDURE IF EXISTS CalculateRentalPrice;
